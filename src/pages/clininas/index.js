            ...
            <View style = {styles.descricao}>
                ...
                <View style = {styles.detalhes}>
                    ...
                    <View>
                        ...
                        <Text style = {styles.local}>Av. República Argentina, 54 - Vila Militar, Foz do Iguaçu - PR</Text>
                    </View>
                ...
                <View style = {styles.detalhes}>
                    ...
                    <View>
                        ...
                        <Text style = {styles.local}>Rua Xavier da Silva, 1670 - Centro, Foz do Iguaçu - PR</Text>
                    </View>
